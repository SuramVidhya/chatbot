...
function report_issue(agent)
{
  ...
  var issue_vals={1:"Buffering problem",2:"Slow Internet",3:"Internet down",4:"No connectivity"};
    ...
    [
      {
        ...
        "subtitle": "Press '1' for Buffering problem",
        "event": {
          "name": "",
          "languageCode": "",
          "parameters": {}
      ...
      },
	  {
        "type": "list",
        "title": "Internet down",
        "subtitle": "Press '3' for Internet down",
        "event": {
          "name": "",
          "languageCode": "",
          "parameters": {}
...
app.listen(process.env.PORT || 8567);
